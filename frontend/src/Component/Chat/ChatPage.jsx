...
const ChatPage = () => {
    ...
    const fetchGroupMessage=async(id)=>{
        try{
        const response=await publicAxios.get('/chat/fetchMessage',{params:{group_id:id}},{
            headers:{
                'Content-Type':'application/Json',
            },
            withCredentials:true,
    ...
    if (client.readyState === client.OPEN) {
        ...
        // Handle the scenario when the WebSocket is not open
    }
};
                        ...
                        <div className="flex border border-grey rounded shadow-lg h-full">
                            ...
                            <div className="w-1/3 border flex flex-col">
                                ...
                                {Array.isArray(fetchGroup) && fetchGroup.length > 0 ? (
                                    ...
                                    (<div onClick={()=>fetchGroupMessage(group.id)} className="px-3 flex items-center bg-grey-light cursor-pointer">
                            ...
                            <div className="w-2/3 border flex flex-col">
                                ...
                                <div className="bg-grey-lighter px-4 py-4 flex items-center">
                                    ...
                                    <div className="flex-1 mx-4" >
                                        ...
                                        // onFocus={() =>{console.log("Input focused"); setIsTyping(true)}}
                                        // onBlur={() =>{console.log("Input blurred"); setIsTyping(false)}}
                                        />
                                    </div>
                                    <div className='flex'>
                                        <div className='p-1'>
                                        ...
                                        <div className='p-1'>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6" onClick={sendMessage}>
